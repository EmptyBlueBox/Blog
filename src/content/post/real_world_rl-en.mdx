...
Physical Intelligence recently released the technical report for $\pi_{0.6}^*$ [^7]. One detail that stands out is the use of real‑world RL directly on physical robots. Real‑world RL has been quietly accumulating results over the past few years, so this feels like a good moment to step back and look at how the line of work has evolved and where it might go next.
...
After these papers, real‑world RL stopped sounding like a distant idea and started to look like a workable research direction.
...
From a research perspective, the role of real‑world RL has slowly shifted:
...
Looking ahead, several directions seem particularly interesting:
...
This is arguably the most appealing part of real‑world RL. It does not replace the rest of the learning stack. Instead, it helps the entire robot system survive contact with the real world.
