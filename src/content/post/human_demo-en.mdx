...
The "human demonstration" mentioned here mainly refers to human motion capture data, such as keypoints, skeletons, or mesh data, rather than human video egocentric data.
