...
Specifically, 在人手上是指把人手或者机械手的动作转移到另一个手同时保持能够操控同样物体的一致性, 比如给定人手拿起一个木块的动作, 能够通过 retargeting 将动作转移给机械手, 最终让它也拿起这个木块. 所以这项能力是 teleoperation, imitation learning 和数据扩增的关键枢纽, 因为它让已有的人类示教得以跨本体复用.
