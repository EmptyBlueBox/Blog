...
<TutorialImages maxWidth="100%" images={[{src:'https://cdn.lyt0112.com/2026/09/cubing/fto-pyraminx-map-98f9418d3f63.svg',alt:'The final three FTO corners correspond to the three edges inside the central triangle of a Pyraminx net',width:1400,height:530,caption:'Matching numbers link the FTO corners on the left to the edges in the Pyraminx net on the right.'}]} />
