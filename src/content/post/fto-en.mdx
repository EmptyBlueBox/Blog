...
<TutorialImages images={[
 {src:'https://cdn.lyt0112.com/2026/09/cubing/fto-center-insert-before-3bfb67f12b8c.svg',alt:'The starting state for center insertion',width:1000,height:560,caption:'Center insertion · before',algorithm:"R U R'"},
 {src:'https://cdn.lyt0112.com/2026/09/cubing/fto-center-insert-after-bbcee8c95948.svg',alt:'The completed center insertion',width:1000,height:560,caption:'Center insertion · after'}
]} />
...
<TutorialImages images={[{src:'https://cdn.lyt0112.com/2026/09/cubing/fto-center-false-insert-8b9a3c59d50c.svg',alt:'A last-two-centers case requiring a false insertion',width:1000,height:560,caption:'Last two centers: false insertion',algorithm:"U R U' R' U' R U R'"}]} />
...
<TutorialImages maxWidth="100%" images={[{src:'https://cdn.lyt0112.com/2026/09/cubing/fto-pyraminx-map-614acce18e9e.svg',alt:'The final three FTO corners correspond to the three edges around the base of a Pyraminx',width:1400,height:530,caption:'Matching numbers link the FTO corners on the left to the Pyraminx edges on the right.'}]} />
...
<TutorialImages images={[
 {src:'https://cdn.lyt0112.com/2026/09/cubing/fto-pairing-1-bf1833f27c2c.svg',alt:'The starting state for the pairing example',width:1000,height:560,caption:'1 · Start'},
 {src:'https://cdn.lyt0112.com/2026/09/cubing/fto-pairing-2-8148b87e2d3e.svg',alt:'A corner-triangle pair formed with U',width:1000,height:560,caption:'2 · After U'},
 {src:'https://cdn.lyt0112.com/2026/09/cubing/fto-pairing-3-6bfd3a694779.svg',alt:'H moves the pair to the top face',width:1000,height:560,caption:'3 · Then H'},
 {src:'https://cdn.lyt0112.com/2026/09/cubing/fto-pairing-4-e6b1c2293110.svg',alt:'U prime completes pairing and leads to the S case',width:1000,height:560,caption:"4 · Finally U'"}
]} />
...
Each pair places the FTO beside its Pyraminx counterpart. Corners and edges with the same number have matching destinations and flips. Both diagrams show the state before the algorithm; each Pyraminx diagram includes a view toward the yellow bottom face from below and a rear view.

<TutorialImages images={[
 {src:'https://cdn.lyt0112.com/2026/09/cubing/fto-tl-s-c1ec80ba1e95.svg',note:"Corners 1 and 3 are flipped. The corners at positions 1, 2, 3 belong at 2, 3, 1.",alt:'Front and rear views of the S top-corner case',width:1000,height:560,caption:'FTO · Cycle with flips · S',algorithm:'S'},
 {src:'https://cdn.lyt0112.com/2026/09/cubing/fto-pyraminx-tl-s-d53ec5c0782e.svg',note:"Edges 1 and 3 are flipped. The edges at positions 1, 2, 3 belong at 2, 3, 1.",alt:"Pyraminx · Cycle with flips · Sₚ, with edges corresponding to the paired FTO corner diagram",width:1000,height:560,caption:"Pyraminx · Cycle with flips · Sₚ",algorithm:'Sₚ'}
]} />

<TutorialImages images={[
 {src:'https://cdn.lyt0112.com/2026/09/cubing/fto-tl-h-d95e047ec6c8.svg',note:"Corners 1 and 3 are flipped. The corners at positions 1, 2, 3 belong at 3, 1, 2.",alt:'Front and rear views of the H top-corner case',width:1000,height:560,caption:'FTO · Cycle with flips · H',algorithm:'H'},
 {src:'https://cdn.lyt0112.com/2026/09/cubing/fto-pyraminx-tl-h-5455151693ea.svg',note:"Edges 1 and 3 are flipped. The edges at positions 1, 2, 3 belong at 3, 1, 2.",alt:"Pyraminx · Cycle with flips · Hₚ, with edges corresponding to the paired FTO corner diagram",width:1000,height:560,caption:"Pyraminx · Cycle with flips · Hₚ",algorithm:'Hₚ'}
]} />

<TutorialImages images={[
 {src:'https://cdn.lyt0112.com/2026/09/cubing/fto-tl-flip-090decbfaad1.svg',note:"All three corners are in position; the yellow stickers at 2 and 3 face sideways.",alt:'Corners 2 and 3 in their correct positions but flipped',width:1000,height:560,caption:'FTO · Double flip · corners 2 and 3',algorithm:'H S'},
 {src:'https://cdn.lyt0112.com/2026/09/cubing/fto-pyraminx-tl-flip-afee58659938.svg',note:"All three edges are in position; the yellow stickers at 2 and 3 face sideways.",alt:"Pyraminx · Double flip · edges 2 and 3, with edges corresponding to the paired FTO corner diagram",width:1000,height:560,caption:"Pyraminx · Double flip · edges 2 and 3",algorithm:'Hₚ Sₚ'}
]} />

<TutorialImages images={[
 {src:'https://cdn.lyt0112.com/2026/09/cubing/fto-tl-cycle-a-c8c001422aef.svg',note:"All yellow stickers face U. The corners at positions 1, 2, 3 belong at 2, 3, 1.",alt:'Correctly oriented corners requiring the first three-cycle direction',width:1000,height:560,caption:'FTO · Pure three-cycle · direction one',algorithm:'S⁻¹ H'},
 {src:'https://cdn.lyt0112.com/2026/09/cubing/fto-pyraminx-tl-cycle-a-a1993f3afc15.svg',note:"All yellow stickers face the bottom. The edges at positions 1, 2, 3 belong at 2, 3, 1.",alt:"Pyraminx · Pure three-cycle · direction one, with edges corresponding to the paired FTO corner diagram",width:1000,height:560,caption:"Pyraminx · Pure three-cycle · direction one",algorithm:'Sₚ⁻¹ Hₚ'}
]} />

<TutorialImages images={[
 {src:'https://cdn.lyt0112.com/2026/09/cubing/fto-tl-cycle-b-6728e50519af.svg',note:"All yellow stickers face U. The corners at positions 1, 2, 3 belong at 3, 1, 2.",alt:'Correctly oriented corners requiring the opposite three-cycle direction',width:1000,height:560,caption:'FTO · Pure three-cycle · direction two',algorithm:'H⁻¹ S'},
 {src:'https://cdn.lyt0112.com/2026/09/cubing/fto-pyraminx-tl-cycle-b-7a41acadc9ea.svg',note:"All yellow stickers face the bottom. The edges at positions 1, 2, 3 belong at 3, 1, 2.",alt:"Pyraminx · Pure three-cycle · direction two, with edges corresponding to the paired FTO corner diagram",width:1000,height:560,caption:"Pyraminx · Pure three-cycle · direction two",algorithm:'Hₚ⁻¹ Sₚ'}
]} />
...
<TutorialImages images={[{src:'https://cdn.lyt0112.com/2026/09/cubing/fto-lt-swap-341d110c0f41.svg',alt:'Two-triangle swap grip with yellow on the left and the orange turning layer on top, shown from the front and rear',width:1000,height:560,caption:'Two-triangle swap · match this grip',algorithm:'OLL 28',note:'Left: working view. Right: rear view. Outlines mark the two triangles to exchange.'}]} />
...
<TutorialImages images={[
 {src:'https://cdn.lyt0112.com/2026/09/cubing/fto-lt-cycle-a-f4fe8a527fda.svg',alt:'First three-cycle state with arrows marking clockwise turns of the back-right and bottom faces',width:1000,height:560,caption:'Direction one: before adjustment',note:'Triangle destinations: F → BL → BR → F. Follow arrows 1 and 2, then use the grip on the right.'},
 {src:'https://cdn.lyt0112.com/2026/09/cubing/fto-lt-cycle-a-grip-e50e35bbd477.svg',alt:'OLL 57 grip after the two adjustments for the first three-cycle, shown from the front and rear',width:1000,height:560,caption:'Direction one: adjusted OLL grip',algorithm:'OLL 57',note:'After OLL, return to the initial grip. Undo the bottom turn, then the back-right turn.'}
]} />

<TutorialImages images={[
 {src:'https://cdn.lyt0112.com/2026/09/cubing/fto-lt-cycle-b-7a3502f996dd.svg',alt:'Second three-cycle state with arrows marking clockwise turns of the back-right and bottom faces',width:1000,height:560,caption:'Direction two: before adjustment',note:'Triangle destinations: F → BR → BL → F. Follow arrows 1 and 2, then use the grip on the right.'},
 {src:'https://cdn.lyt0112.com/2026/09/cubing/fto-lt-cycle-b-grip-ac625736916e.svg',alt:'OLL 28 grip after the two adjustments for the second three-cycle, shown from the front and rear',width:1000,height:560,caption:'Direction two: adjusted OLL grip',algorithm:'OLL 28',note:'After OLL, return to the initial grip. Undo the bottom turn, then the back-right turn.'}
]} />
